...
pred Transition[s, s': GameState]{
	...
	not (Win[s, X] or Win[s, O] or Draw[s]) =>
		NextTurn[s] = O => CheckSymbols[s, s', O]
			else NextTurn[s] = X => CheckSymbols[s, s', X]
...
pred CheckSymbols[s, s': GameState, sym: Symbol]{
	s'.turn = sym => (#(s.sq1 & sym)) fun/add (#(s.sq2 & sym)) fun/add (#(s.sq3 & sym)) fun/add (#(s.sq4 & sym))
		fun/add (#(s.sq5 & sym)) fun/add (#(s.sq6 & sym)) fun/add (#(s.sq7 & sym)) fun/add (#(s.sq8 & sym))
		fun/add (#(s.sq9 & sym)) fun/add 1
			=   (#(s'.sq1 & sym)) fun/add (#(s'.sq2 & sym)) fun/add (#(s'.sq3 & sym)) fun/add (#(s'.sq4 & sym))
				fun/add (#(s'.sq5 & sym)) fun/add (#(s'.sq6 & sym)) fun/add (#(s'.sq7 & sym)) fun/add (#(s'.sq8 & sym))
				fun/add (#(s'.sq9 & sym))
}
...
pred DrawTrace {
	...
	all s: GameState-last |
		let s' = s.next |
			Transition[s, s'] and not (Win[s, O] or Win[s, X])
	Draw[last]
}
